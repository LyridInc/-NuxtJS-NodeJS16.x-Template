...
<a href="https://app.lyrid.io/login?one-click-deploy=true&origin=github&repository-url=https://github.com/LyridInc/NuxtJS-NodeJS16.x-Template.git&env=empty&project-type=nuxtjs&repo-name=NuxtJS-NodeJS16.x-Template">
  <button>
